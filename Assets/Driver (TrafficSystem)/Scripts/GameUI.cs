...
public class GameUI : MonoBehaviour
{
    ...
    public void ShowBigMap(bool active)
    {
        ...
        if (mapUI.mapPlane.GetComponent<MoveMap>())
			mapUI.mapPlane.GetComponent<MoveMap>().enabled = false;
    ...
    void Update()
    {
        if (panels.bigMap.activeSelf == false)
        {
            ...
            {
                ShowVehicleUI();
                if (panels.vehicleControl) panels.vehicleControl.SetActive(true);
            ...
            else
            {
                ...
                if (panels.vehicleControl) panels.vehicleControl.SetActive(false); 
